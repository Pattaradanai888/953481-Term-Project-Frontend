...
const recipeLoading = computed(() => searchStore.recipeLoading);
const recipeError = computed(() => searchStore.recipeError);
...
const performSearch = async () => {
	...
	await searchStore.searchRecipes(searchQuery.value, 1, searchStore.perPage);
};

const handlePageChange = async (page) => {
	await searchStore.searchRecipes(searchQuery.value, page, searchStore.perPage);
};
